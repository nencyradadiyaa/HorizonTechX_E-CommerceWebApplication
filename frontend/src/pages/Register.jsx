...
import { Cpu, User, Mail, Lock, AlertCircle, Loader } from 'lucide-react';
...
const Register = () => {
  ...
  const { register, user, loading, error, setError } = useContext(AuthContext);
    ...
    <div className="flex-grow flex items-center justify-center py-20 px-4 relative">
      ...
      <div className="w-full max-w-md glass-panel rounded-3xl p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400 text-xs sm:text-sm">Join HorizonTechX e-commerce ecosystem</p>
        </div>
        ...
        <p className="text-center text-xs text-slate-500">
          ...
          <Link to="/login" className="text-brand-400 hover:text-brand-300 font-medium hover:underline transition-all">
            Sign In
          </Link>
        </p>
      </div>
